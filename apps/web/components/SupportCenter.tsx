  ...
  return (
    <section className="page-wrap support-page">
      ...
      <div className="support-grid">
        ...
        <article><h2>机考帮助</h2><ul><li>黄色标记表示你主动标记的题目。</li><li>答案不会自动保存；只有主动点击“保存草稿”才会生成本机恢复草稿。</li><li>普通退出或从题卡再次开始均为空白练习；只有从“管理草稿”点击继续，才会恢复已手动保存的答案和计时。</li><li>暂停只冻结计时，不会清空答案；交卷后才会显示答案与解析。</li></ul></article>
